...
def build_system_prompt(
    ...
    *,
    ...
    return (
        ...
        "number(s). Place the citation INLINE inside the \"answer\" text as a "
        "bracketed marker (e.g. \"Water boils at 100 C [1].\") immediately after "
        "the claim it supports, using the source's number. Every marker you write "
        "inline MUST also appear as an entry in the \"citations\" array, and every "
        "entry in \"citations\" MUST have its marker present inline in the answer "
        "text. This applies to prose and bullet/Q&A formats alike.\n"
